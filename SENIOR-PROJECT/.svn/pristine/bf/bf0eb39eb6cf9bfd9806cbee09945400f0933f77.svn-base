    ...
    public class UserController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            if (Request != null && Request.Params["q"] != null)
            {
                ...
                users = db.Member.Where(x => x.UserName.ToLower().Contains(q.ToLower())).ToList();
            }
            else
            {
                users = db.Member.ToList();
            }
        ...
        public ActionResult Member(string username)
        {
            ...
            Member user = db.Member.FirstOrDefault(x => x.UserName == idString);
        ...
        public ActionResult Edit(Member user)
        {
            ...
            if (db.Member.Any(x => x.UserName == user.UserName && x.memberId != user.memberId))
            {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (image != null)
                {
                    string realFileName = user.memberId + image.FileName;
                    string baseDirectory = AppDomain.CurrentDomain.BaseDirectory;
                    string imageFolder = ConfigurationManager.AppSettings["UserImagePath"].ToString();
                    string fullPath = baseDirectory + imageFolder;
                    string relativeImagePath = imageFolder + "\\" + realFileName;
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            if (user != null)
            {
                try
                {
                    ...
                    List<Member> users = db.Member.ToList();
